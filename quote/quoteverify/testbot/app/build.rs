...
impl SGX {
    fn new(c_sdk_path: &str, is_sim: bool, rust_sdk_path: &str) -> Result<Self, String> {
        ...
        Ok(SGX {
            ...
            fs_lib: "sgx_uprotected_fs".to_string(),
            rts_lib,
            service_lib,
...
fn main() {
    ...
    println!("cargo:rustc-link-lib=dylib={}", sgx.service_lib);
    println!("cargo:rustc-link-lib=dylib={}", sgx.fs_lib);
}
